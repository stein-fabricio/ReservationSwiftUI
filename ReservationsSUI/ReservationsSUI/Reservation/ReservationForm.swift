...
//                            print("Party field: \(party)")
    ...
    private func validateForm() {
        ...
        let numbersAreValid = isValid(numbers: customerPhoneNumber)
        ...
        guard numbersAreValid
        else {
            var invalidMessage = ""
            if !customerPhoneNumber.isEmpty || !isValid(numbers: customerPhoneNumber) {
                invalidMessage = "The phone number should have at least 8 numbers. Only numbers acccepted."
            }
